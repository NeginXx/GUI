...
static const char* kFontName = "OpenSans-Light.ttf";
...
static const uint kStandardResizeOfs = 1;
...
static const uint kStandardFrameWidth = 1;
static const uint kStandardThumbWidth = 6;
